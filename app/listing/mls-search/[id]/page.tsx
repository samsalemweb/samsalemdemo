                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-2xl border border-border p-6 sticky top-24">
                            ...
                            <p className="text-sm text-muted mb-4">{listing.ListOfficeName}</p>
                            ...
                            {isSamListing ? (
                                ...
                                <div>
                                    <Link
                                        ...
                                        className="btn-pill btn-pill-dark w-full justify-center"
                                    >
                                        Ask Sam about this listing
                                    </Link>
                                    <p className="text-xs text-muted text-center mt-3">
                                        Sam can help you with any MLS® listing
                                    </p>
                                </div>
                            )}
                            ...
                            <div className="mt-6 pt-4 border-t border-border">
                                <p className="text-[10px] text-muted/60 leading-relaxed">
                                    Listing courtesy of {listing.ListOfficeName}. Data last updated {lastUpdated}.
                                </p>
                            </div>
                        </div>
                    </div>
